...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="services.html">景点</a>
                    </li>
                    <li>
                        <a href="contact.html">游记</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">秦皇岛景点速览</h1>
                <ol class="breadcrumb">
                    <li class="active">秦皇岛的北戴河地区，却是一个四时皆佳的旅游胜地。不过，北戴河毕竟属于北方城市，人们出行时间还是选择在5月到10月间为最好，另外，北戴河的鸟类资源特别丰富，如果在春、秋两季来此地旅游，能看到候鸟南飞或北归的壮观情形。</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
                ...
                <div class="screen">
                    ...
                    <div class="screenList">
                        <dl class="screenItem" id="item1">
                            <dt>景点名称:</dt>
                            <dd><a href="#" onclick="addSel(this)">老虎是公园</a></dd>
                            <dd><a href="#" onclick="addSel(this)">北戴河</a></dd>
                            <dd><a href="#" onclick="addSel(this)">123</a></dd>
                            <div class="clear"></div>
                        </dl>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header" style="float:left;">热门景点</h2>
                <form method="get" action="" style="float:right;margin-top: 15px;">
                    <fieldset>
                    <input id="s" name="s" value="" type="text">
                    <input id="x" value="查找" type="submit">
                    </fieldset>
                </form>
            </div>
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    <img class="img-responsive percent" src="http://dimg08.c-ctrip.com/images/fd/tg/g3/M0A/7C/52/CggYGlXNWp-AOCniACrChZckLtg040_C_270_170.jpg" alt="">
                    <div class="caption">
                        <h3>鸽子窝公园<br>
                            <small>
                                <input id="input-2ba" disabled="disabled" type="number" class="rating" min="0" max="5" step="0.5" data-stars=5 data-symbol="&#xe005;" data-default-caption="{rating} hearts" data-star-captions="{}" value="3" data-size="sm">
                            </small>
                        </h3>
                        <p>鸽子窝公园比想象中大很多，很美</p>
